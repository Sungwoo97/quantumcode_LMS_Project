...
(4, 'admin', 'admin@shop.com', '관리자', '33275a8aa48ea918bd53a9181aa975f15ab0d0645398f5918a006d08675c1cb27d5c645dbd084eee56e675e25ba4019f2ecea37ca9e2995b49fcb12c096a032e', '2023-01-01 17:12:32', 100, '2024-11-24 22:28:56', NULL);
...
(62, 'A0001B0001C0001', 56, '관리자가 등록한 강의', '/qc/admin/upload/20241119042317924625.png', 'admin', 1, 0, 0, 1, 1000, 1000, '2024-11-11', '2025-02-11', 'test', '<p>test</p>', '', '1', '', 'Array', '2024-11-19 12:23:17', 0, 80),
...
(72, 'A0001B0002C0001', 66, '설민석의 mysql', '/qc/admin/upload/20241120045823750741.jpg', 'sulminsuk', 0, 1, 1, 0, 100000, 10000, '2023-06-20', '2023-09-20', '설민석의 nodejs', '<p>설민석의 nodejs</p>', '', '1', '', 'Array', '2024-11-20 12:58:23', 0, 23),
(73, 'A0001B0002C0001', 67, '자바스크립트', '/qc/admin/upload/20241120050013976917.png', 'kangdongwon', 1, 0, 0, 1, 100000, 10000, '2024-11-19', '2025-02-19', '자바스크립트', '<p>자바스크립트</p>', '', '2', '', 'Array', '2024-11-20 13:00:13', 0, 67),
(74, 'A0002B0003C0008', 68, 'go언어 고수 되는 방법', '/qc/admin/upload/20241124144124190823.jpg', 'kwondohyung', 0, 0, 0, 1, 150000, 10000, '2024-10-22', '2025-01-22', 'go언어 고수 되는 방법', '<p>go언어 고수 되는 방법</p>', '', '1', '', 'Array', '2024-11-20 13:01:12', 0, 51),
(75, 'A0001B0001C0002', 69, '빠니와 함께하는 css여행', '/qc/admin/upload/20241124144001164459.png', 'panibottle', 0, 1, 1, 0, 200000, 10000, '2024-09-18', '2024-12-18', '빠니와 함께하는 css여행', '<p>빠니와 함께하는 css여행</p>', '', '1', '', 'Array', '2024-11-20 13:02:22', 0, 31),
(76, 'A0001B0001C0001', 70, '지현샘과 함께하는 c++', '/qc/admin/upload/20241120050628168178.png', 'admin', 1, 0, 0, 1, 250000, 10000, '2024-07-16', '2024-10-16', '지현샘과 함께하는 c++', '<p>지현샘과 함께하는 c++</p>', '', '2', '', 'Array', '2024-11-20 13:06:28', 0, 10),
...
(78, 'A0001B0001C0002', 72, 'css정석', '/qc/admin/upload/20241124144023288888.png', 'sinsungbum', 0, 0, 1, 0, 200000, 15000, '2024-09-17', '2024-12-17', 'css정석', '<p>css정석</p>', '', '2', '', 'Array', '2024-11-20 13:08:04', 0, 41),
...
(82, 'A0001B0001C0001', 76, '세아샘과 함께하는 자바스크립트', '/qc/admin/upload/20241120051201391962.png', 'yoonsaeah', 1, 0, 0, 1, 100000, 10000, '2024-08-28', '2024-11-28', '세아샘과 함께하는 자바스크립트', '<p>세아샘과 함께하는 자바스크립트</p>', '', '1', '', 'Array', '2024-11-20 13:12:01', 0, 48),
...
(84, 'A0001B0001C0001', 78, '기상샘과 함께하는 파이썬 여행', '/qc/admin/upload/20241120051342146639.jpg', 'wakeup', 0, 1, 0, 0, 254600, 10000, '2024-11-20', '2025-02-20', '기상샘과 함께하는 파이썬 여행', '<p>기상샘과 함께하는 파이썬 여행</p>', '', '1', '', 'Array', '2024-11-20 13:13:42', 0, 76),
...
(86, 'A0001B0001C0001', 80, '지영샘과 함께하는 리액트 마스터', '/qc/admin/upload/20241120051508184740.png', 'easyyoung', 1, 0, 0, 1, 200000, 10000, '2024-05-14', '2024-08-14', '지영샘과 함께하는 리액트 마스터', '<p>지영샘과 함께하는 리액트 마스터</p>', '', '1', '', 'Array', '2024-11-20 13:15:08', 0, 89),
...
(94, 'A0001B0001C0001', 61, '승제샘과 함께하는 자바스크립트', '/qc/admin/upload/20241124144236129048.png', 'jungsungjae', 0, 0, 0, 1, 150000, 10000, '2024-11-03', '2025-02-03', '승제샘과 함께하는 자바스크립트', '<p>승제샘과 함께하는 자바스크립트</p>', '', '1', '', 'Array', '2024-11-20 12:52:38', 0, 24),
...
(4, 1, NULL, 'admin', '2024-11-24', '감사합니다~'),
(5, 2, NULL, 'admin', '2024-11-24', '굿');
...
(2, '../img/icon-img/no-image.png', 'shift12', '2024-11-24', 5, '이해하기 쉬워서 좋았습니다. 설명도 너무 좋고, 시각 자료?도 너무 좋았습니다. 제가 이걸 개발 공부 초기에 들었다면 현재의 저보다 더 나은 사람이 되었을 것 같아요.당연히 이걸 들은 미래의 저는 아주 똑똑해질 것 같습니다 감사해요');
...
INSERT INTO `tomembermessages` (`id`, `sender_id`, `receiver_id`, `message_content`, `sent_at`, `is_read`) VALUES
...
INSERT INTO `toteachermessages` (`id`, `sender_id`, `receiver_id`, `message_content`, `sent_at`, `is_read`) VALUES
(1, 4, 1, '222', '2024-11-22 15:07:24', 0),
(2, 4, 2, '123123sf', '2024-11-22 15:07:41', 0);
...
--
ALTER TABLE `lecture_reply`
  MODIFY `lpid` int(11) NOT NULL AUTO_INCREMENT COMMENT '답글 고유번호', AUTO_INCREMENT=6;
