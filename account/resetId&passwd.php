...
<body>
    <div class="container">
        <div class="reset-container text-center">
            ...
            <p class="mb-4" style="font-size: 13px;">카카오톡 로그인의 경우 해당 주소에서 변경해주십시오.</p>
            ...
            <p class="mt-1" style="font-size: 12px;"><a href="contact_support.php" class="text-decoration-none">고객 지원에 문의하기</a></p>
        </div>
    </div>
