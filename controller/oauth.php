...
try {
    ...
    */
    ...
    try {
        ...
        // DB 내 같은 이메일이 있는지 확인
        $sql_query = "SELECT * FROM members WHERE memEmail = '" . $json_profile_data_array["email"] . "' ";
        ...
        if ($memInfo) {
            ...
            // 신규 회원 처리
            $sql_query = "INSERT INTO membersTEST (memName, memPassword, memEmail, memId, memProfilePath, memProfileName, memAddr)
                          VALUES (
