...
$sql = "INSERT INTO coupons (coupon_name, coupon_image, coupon_type, coupon_price, coupon_ratio, status, startdate, enddate, userid)
        VALUES ('$coupon_name', '$coupon_image', '$coupon_type', $coupon_price, $coupon_ratio, $status, '$startdate', '$enddate', '$userid')";
