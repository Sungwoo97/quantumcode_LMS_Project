  ...
  <nav class="d-flex flex-column align-items-center justify-content-between">
    <div class="nav_aside_menu">
      <h1 class="top_logo d-flex justify-content-center">
        <a href="<?php echo isset($_SESSION['AUID']) ? '/admin/index.php' : '/admin/login.php'; ?>">
          <img src="http://<?= $_SERVER['HTTP_HOST']; ?>/admin/img/core-img/Normal_Logo.svg" alt="탑 로고">
        </a>
      </h1>
    ...
    ?>
      <div class="admin_account d-flex gap-3 align-items-center">
        ...
        <a href="http://<?= $_SERVER['HTTP_HOST'] ?>/admin/login.php">로그인</a>
      </div>
    ...
    ?>
      <div class="admin_account">
        ...
        <a href="http://<?= $_SERVER['HTTP_HOST'] ?>/admin/logout.php">로그아웃</a>
      </div>
    <?php
    }
    ?>
