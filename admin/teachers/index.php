      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div class="accordion-item">
          ...
          <ul id="nav_cate_board" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
            <li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/qc/admin/board/t_board_list.php?category=notice">공지사항</a></li>
            <li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/qc/admin/board/t_board_list.php?category=event">이벤트</a></li>
            <li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/qc/admin/board/t_board_list.php?category=qna">Q&A</a></li>
            <li><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/qc/admin/board/t_board_list.php?category=free">자유게시판</a></li>
          </ul>
        </div>
      </div>
    </div>
