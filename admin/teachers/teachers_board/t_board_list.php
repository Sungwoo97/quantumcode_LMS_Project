...
?>
<div class="container">
<form action="t_board_list.php?category=<?=$category?>" method="POST" class="board_serch d-flex align-items-center justify-content-between mb-3">
  ...
  <nav aria-label="Page navigation">
    <ul class="pagination">
      ...
      ?>
        <li class="page-item <?= $active; ?>"><a class="page-link" href="t_board_list.php?category=<?=$category?>&page=<?= $i; ?>&search_keyword=<?=$search_keyword?>"><?= $i; ?></a></li>
      <?php
        }
        $next = $block_end + 1;
